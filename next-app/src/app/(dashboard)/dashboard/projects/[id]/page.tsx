      ...
      <main className="p-8 max-w-7xl mx-auto w-full space-y-8 pb-20">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-zinc-900/50 p-6 rounded-3xl border border-zinc-800/50 hover:border-blue-600/30 transition-all group overflow-hidden relative">
               <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                  <Users2 className="w-20 h-20" />
               </div>
               <div className="relative z-10">
                  <div className="w-12 h-12 bg-emerald-600/10 rounded-2xl flex items-center justify-center text-emerald-500 mb-4 border border-emerald-600/20">
                    <Users2 className="w-6 h-6" />
                  </div>
                  <h4 className="text-lg font-bold text-white mb-1">Team Members</h4>
                  <p className="text-xs text-zinc-500 font-bold mb-4 uppercase tracking-widest">{team.length} Users</p>
                  <span className="text-xs font-bold text-blue-500 group-hover:underline">View Team →</span>
               </div>
            </div>
          </div>
        </div>
        ...
        {/* Recent Project Activity Placeholder */}
        <div className="space-y-6">
          <div className="flex items-center gap-2">
